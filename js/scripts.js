$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Свадьба Артема и Ольги",

            // Event start date
            start: new Date('Aug 3, 2024 10:00'),
            ...
            end: new Date('Aug 4, 2024 00:00'),

            // Event Address
            address: 'пл. Речников, 1, Чебоксары, Чувашская Респ., 428000',
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $('#alert-wrapper').html(alert_markup('info', '<strong>Секунду</strong>, мы сохраняем Ваши данные.'));

        if (MD5($('#invite_code').val()) !== 'e92fbd21a75239a4194986de4d04d5b4'
            ...
            $.post('https://script.google.com/macros/s/AKfycbyDCZOFesuxRez23TFtG8aeInoTNnKoJoiFSbWxVaKxPZs6GxsVazKnpCR6SYwXUtekmA/exec', data)
                .done(function (data) {
                    console.log(data);
                ...
                .fail(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html(alert_markup('danger', '<strong>Извините!</strong> Похоже, какие-то неполадки с сервером. '));
                });
        }
    });
